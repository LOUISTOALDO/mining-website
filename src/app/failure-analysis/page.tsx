...
import { ArrowLeft, Search, AlertCircle, TrendingDown, FileText, BarChart3, Target, ArrowRight } from "lucide-react"

export default function FailureAnalysisGuide() {
        ...
        <div style={{maxWidth: '1200px', margin: '0 auto', padding: '0 2rem'}}>
          <div style={{textAlign: 'center', marginBottom: '3rem'}}>
            ...
            <p style={{fontSize: '1.25rem', color: '#d1d5db', lineHeight: '1.6', maxWidth: '800px', margin: '0 auto'}}>
              Master the art of analyzing equipment failures to prevent future incidents and optimize maintenance strategies.
            </p>
          </div>
        </div>
      </section>
          ...
          <div style={{display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', alignItems: 'start'}}>
            ...
            <div>
              ...
              <p style={{fontSize: '1.125rem', color: '#d1d5db', lineHeight: '1.7', marginBottom: '2rem'}}>
                Effective failure analysis is crucial for understanding root causes, preventing recurrence, and improving 
                equipment reliability. Our systematic approach helps mining operations learn from failures and build 
                more robust maintenance programs.
              </p>
              ...
              <div style={{display: 'grid', gap: '1.5rem', marginBottom: '3rem'}}>
                <div style={{display: 'flex', alignItems: 'start', gap: '1rem'}}>
                  <div style={{width: '3rem', height: '3rem', background: 'linear-gradient(135deg, #ef4444, #dc2626)', borderRadius: '0.5rem', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0}}>
                    <Search style={{width: '1.5rem', height: '1.5rem', color: '#ffffff'}} />
                  </div>
                  <div>
                    ...
                    <p style={{color: '#d1d5db', lineHeight: '1.6'}}>
                      Systematic investigation to identify the fundamental cause of equipment failures using proven methodologies.
                    </p>
                  </div>
                </div>
                ...
                <div style={{display: 'flex', alignItems: 'start', gap: '1rem'}}>
                  <div style={{width: '3rem', height: '3rem', background: 'linear-gradient(135deg, #f59e0b, #d97706)', borderRadius: '0.5rem', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0}}>
                    <TrendingDown style={{width: '1.5rem', height: '1.5rem', color: '#ffffff'}} />
                  </div>
                  <div>
                    <h4 style={{fontSize: '1.125rem', fontWeight: '600', color: '#ffffff', marginBottom: '0.5rem'}}>
                    ...
                    <p style={{color: '#d1d5db', lineHeight: '1.6'}}>
                      Comprehensive evaluation of how equipment can fail and the potential consequences of each failure mode.
                    </p>
                  </div>
                </div>
                ...
                <div style={{display: 'flex', alignItems: 'start', gap: '1rem'}}>
                  ...
                  <div>
                    ...
                    <p style={{color: '#d1d5db', lineHeight: '1.6'}}>
                      Data-driven analysis of failure patterns, frequencies, and correlations to predict future issues.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div style={{display: 'grid', gap: '1rem'}}>
                <div style={{display: 'flex', alignItems: 'center', gap: '1rem', padding: '1rem', backgroundColor: '#111111', borderRadius: '0.5rem', border: '1px solid #2a2a2a'}}>
                  ...
                  <span style={{color: '#d1d5db'}}>Immediate response and safety measures</span>
                </div>
                <div style={{display: 'flex', alignItems: 'center', gap: '1rem', padding: '1rem', backgroundColor: '#111111', borderRadius: '0.5rem', border: '1px solid #2a2a2a'}}>
                  ...
                  <span style={{color: '#d1d5db'}}>Evidence collection and documentation</span>
                </div>
                <div style={{display: 'flex', alignItems: 'center', gap: '1rem', padding: '1rem', backgroundColor: '#111111', borderRadius: '0.5rem', border: '1px solid #2a2a2a'}}>
                  ...
                  <span style={{color: '#d1d5db'}}>Timeline reconstruction</span>
                </div>
                <div style={{display: 'flex', alignItems: 'center', gap: '1rem', padding: '1rem', backgroundColor: '#111111', borderRadius: '0.5rem', border: '1px solid #2a2a2a'}}>
                  ...
                  <span style={{color: '#d1d5db'}}>Root cause identification</span>
                </div>
                <div style={{display: 'flex', alignItems: 'center', gap: '1rem', padding: '1rem', backgroundColor: '#111111', borderRadius: '0.5rem', border: '1px solid #2a2a2a'}}>
                  ...
                  <span style={{color: '#d1d5db'}}>Corrective action implementation</span>
                </div>
                <div style={{display: 'flex', alignItems: 'center', gap: '1rem', padding: '1rem', backgroundColor: '#111111', borderRadius: '0.5rem', border: '1px solid #2a2a2a'}}>
                  <div style={{width: '2rem', height: '2rem', background: '#ef4444', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#ffffff', fontWeight: '600', fontSize: '0.875rem'}}>6</div>
                  <span style={{color: '#d1d5db'}}>Follow-up and prevention measures</span>
                </div>
              </div>
            </div>
            ...
            <div style={{position: 'sticky', top: '6rem'}}>
              <div style={{backgroundColor: '#111111', padding: '2rem', borderRadius: '1rem', border: '1px solid #2a2a2a', marginBottom: '2rem'}}>
                ...
                <div style={{height: '300px', background: 'linear-gradient(135deg, #1e293b, #334155)', borderRadius: '0.5rem', display: 'flex', flexDirection: 'column', padding: '1rem', gap: '1rem'}}>
                  ...
                  <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'end', height: '120px', borderBottom: '1px solid #374151', paddingBottom: '1rem'}}>
                    <div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.5rem'}}>
                      <div style={{width: '20px', height: '60px', background: '#ef4444', borderRadius: '2px'}}></div>
                      <span style={{color: '#d1d5db', fontSize: '0.75rem'}}>Jan</span>
                    </div>
                    <div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.5rem'}}>
                      <div style={{width: '20px', height: '40px', background: '#f59e0b', borderRadius: '2px'}}></div>
                      <span style={{color: '#d1d5db', fontSize: '0.75rem'}}>Feb</span>
                    </div>
                    <div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.5rem'}}>
                      <div style={{width: '20px', height: '30px', background: '#10b981', borderRadius: '2px'}}></div>
                      <span style={{color: '#d1d5db', fontSize: '0.75rem'}}>Mar</span>
                    </div>
                    <div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.5rem'}}>
                      <div style={{width: '20px', height: '25px', background: '#10b981', borderRadius: '2px'}}></div>
                      <span style={{color: '#d1d5db', fontSize: '0.75rem'}}>Apr</span>
                    </div>
                    <div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.5rem'}}>
                      <div style={{width: '20px', height: '20px', background: '#10b981', borderRadius: '2px'}}></div>
                      <span style={{color: '#d1d5db', fontSize: '0.75rem'}}>May</span>
                    </div>
                  </div>
                  
                  <div style={{display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem'}}>
                    <div style={{textAlign: 'center'}}>
                      <p style={{color: '#ef4444', fontSize: '1.25rem', fontWeight: '600', margin: 0}}>3</p>
                      <p style={{color: '#d1d5db', fontSize: '0.75rem', margin: 0}}>Critical</p>
                    </div>
                    <div style={{textAlign: 'center'}}>
                      <p style={{color: '#10b981', fontSize: '1.25rem', fontWeight: '600', margin: 0}}>12</p>
                      <p style={{color: '#d1d5db', fontSize: '0.75rem', margin: 0}}>Resolved</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div style={{backgroundColor: '#111111', padding: '2rem', borderRadius: '1rem', border: '1px solid #2a2a2a'}}>
                ...
                <div style={{display: 'grid', gap: '1rem'}}>
                  <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>
                    <span style={{color: '#d1d5db'}}>MTBF</span>
                    <span style={{color: '#10b981', fontWeight: '600'}}>1,247h</span>
                  </div>
                  <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>
                    <span style={{color: '#d1d5db'}}>MTTR</span>
                    <span style={{color: '#3b82f6', fontWeight: '600'}}>4.2h</span>
                  </div>
                  <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>
                    <span style={{color: '#d1d5db'}}>Failure Rate</span>
                    <span style={{color: '#f59e0b', fontWeight: '600'}}>0.8%</span>
                  </div>
                  <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>
                    <span style={{color: '#d1d5db'}}>Prevention Rate</span>
        ...
        <div style={{maxWidth: '1200px', margin: '0 auto', padding: '0 2rem'}}>
          ...
          <div style={{display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem'}}>
            <div style={{backgroundColor: '#0a0a0a', padding: '2rem', borderRadius: '1rem', border: '1px solid #2a2a2a'}}>
              ...
              <p style={{color: '#d1d5db', lineHeight: '1.6'}}>
                Contamination, lubrication issues, and excessive loads leading to premature bearing wear and equipment breakdown.
              </p>
            </div>

            <div style={{backgroundColor: '#0a0a0a', padding: '2rem', borderRadius: '1rem', border: '1px solid #2a2a2a'}}>
              <div style={{display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '1rem'}}>
                <Target style={{width: '2rem', height: '2rem', color: '#f59e0b'}} />
                <h3 style={{fontSize: '1.25rem', fontWeight: '600', color: '#ffffff'}}>
                  Hydraulic System Issues
                </h3>
              </div>
              <p style={{color: '#d1d5db', lineHeight: '1.6'}}>
                Fluid contamination, seal failures, and pressure problems causing reduced efficiency and system failures.
              </p>
            </div>
            ...
            <div style={{backgroundColor: '#0a0a0a', padding: '2rem', borderRadius: '1rem', border: '1px solid #2a2a2a'}}>
              ...
              <p style={{color: '#d1d5db', lineHeight: '1.6'}}>
                Motor failures, wiring issues, and control system problems affecting equipment operation and safety.
              </p>
            </div>
          </div>
        </div>
      ...
      <section style={{padding: '4rem 0'}}>
        <div style={{maxWidth: '1200px', margin: '0 auto', padding: '0 2rem', textAlign: 'center'}}>
          <h2 style={{fontSize: '2rem', fontWeight: '700', color: '#ffffff', marginBottom: '1rem'}}>
            Improve Your Failure Analysis
          </h2>
          <p style={{fontSize: '1.125rem', color: '#d1d5db', marginBottom: '2rem'}}>
            Implement systematic failure analysis with Elysium's advanced diagnostic tools and AI-powered insights.
          </p>
